...
const Dashboard = () => {
  ...
  const { isReady, printProjectStructure, deleteFile } = useWebContainerStore();
  ...
  const handleDeleteContract = async (contractId: string) => {
    ...
    try {
      const contractToDelete = currentProject.contracts?.find(
        (c) => c.id === contractId
      );
      if (!contractToDelete) {
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full">
        ...
        <CreateProjectModal
          ...
          disabled={!isReady}
        />
        <Button onClick={() => setIsProjectModalOpen(true)} disabled={!isReady}>
          ...
          <div className="w-full">
            <DashboardCard
              title={`Create Your First ${
                currentProject.platform === "Solana" ? "Program" : "Contract"
              }`}
              description={`Click the button below to create your first ${
                currentProject.platform === "Solana" ? "program" : "contract"
              }.`}
              content={
                <Button
              ...
              content={
                <div className="space-y-4">
                        ...
                        <div className="space-y-1">
                          <div className="flex flex-col items-start">
                            ...
                            <span className="text-xs">
                              {getChainInfo(currentProject.chain)}
                            </span>
                          </div>
                        </div>
                      </div>
                  ...
                  {currentProject.chain && (
                    <div className="mt-2">
                      {findChainByIdAndKey(
                        currentProject.chain.id,
                        currentProject.chain.key
              ...
              <DashboardCard
                ...
                description={`${
                  currentProject.platform === "Solana"
                    ? "Programs"
                    : "Smart contracts"
                } of ${currentProject.name} project`}
                headerAction={
                  <Button
                    onClick={() => setIsContractModalOpen(true)}
                    disabled={!isReady}
